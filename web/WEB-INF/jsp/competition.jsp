                    ...
                    <div class="card-body">
                        ...
                        <div id="myTabContent" class="tab-content ">
                            ...
                            <div class="tab-pane fade in active borderAround2" id="initial">
                                <!--比赛单元项-->
                                <section class="py-5">
                                    <c:forEach items="${initials}" var="comini">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <a href="${pageContext.request.contextPath}/team/competition/${comini.id}"
                                                   class="message card px-5 py-3 mb-4 bg-hover-gradient-primary no-anchor-style border-left-success ">
                                                    <div class="row">
                                                        <div class="col-lg-4 d-flex align-items-center flex-column flex-lg-row text-center text-md-left">
                                                            <span hidden="hidden">${comini.id}</span>
                                                            <h6 class="mb-0 ">${comini.sexgroup} ${comini.agegroup} ${comini.project}</h6>
                                                        </div>
                                                        <div class="col-lg-8 d-flex align-items-center flex-column flex-lg-row text-center text-md-left">
                                                            ...
                                                            <p class=" mb-0 mt-3 mt-lg-0">
                                                                地点：
                                                                <c:choose><c:when
                                                                        test="${comini.place == null}">未定</c:when>
                                                                    <c:otherwise>${comini.place}</c:otherwise>
                                                                </c:choose>
                                                                , 时间：
                                                                <c:choose><c:when
                                                                        test="${comini.date == null}">未定</c:when>
                                                                    <c:otherwise>${comini.date}</c:otherwise>
                                                                </c:choose>
                                                            </p>
                                                        </div>
                                                    </div>
                            ...
                            <div class="tab-pane fade in borderAround2" id="final">
                                <section class="py-5">
                                    <c:forEach items="${finals}" var="comfi">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <a href="${pageContext.request.contextPath}/team/competition/${comfi.id}"
                                                   class="message card px-5 py-3 mb-4 bg-hover-gradient-primary no-anchor-style border-left-success ">
                                                    <div class="row">
                                                        <div class="col-lg-4 d-flex align-items-center flex-column flex-lg-row text-center text-md-left">
                                                            <span hidden="hidden">${comfi.id}</span>
                                                            <h6 class="mb-0 ">${comfi.sexgroup} ${comfi.agegroup} ${comfi.project}</h6>
                                                        </div>
                                                        <div class="col-lg-8 d-flex align-items-center flex-column flex-lg-row text-center text-md-left">
                                                            <div class=" bg-gray-100 roundy px-4 py-1 mr-0 mr-lg-3 mt-2 mt-lg-0 text-dark exclode">
                                                                initial
                                                            ...
                                                            <p class=" mb-0 mt-3 mt-lg-0">
                                                                地点：
                                                                <c:choose><c:when
                                                                        test="${comfi.place == null}">未定</c:when>
                                                                    <c:otherwise>${comfi.place}</c:otherwise>
                                                                </c:choose>
                                                                , 时间：
                                                                <c:choose><c:when
                                                                        test="${comfi.date == null}">未定</c:when>
                                                                    <c:otherwise>${comfi.date}</c:otherwise>
                                                                </c:choose>
                                                            </p>
                                                        </div>
                                                    </div>
